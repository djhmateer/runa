<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<run.Models.Activity>>" %>
...
<%=Html.DropDownList("PersonID", (SelectList)ViewData["People"], new { onchange = "this.form.submit()" })%>
