...
namespace run.Models
{
    ...
    partial void DeleteSport(Sport instance);
		...
		public DB() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["RunConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<weekly_summary> weekly_summaries
		{
			get
			{
				return this.GetTable<weekly_summary>();
			}
		}
	}
	...
	[Table(Name="dbo.weekly_summary")]
	public partial class weekly_summary
	{
